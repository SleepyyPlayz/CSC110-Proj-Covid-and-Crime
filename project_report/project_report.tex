...
Finally, in order to present our findings visually in a GUI, we used \verb+matplotlib.pyplot+ API and \verb+Tkinter+, which allows us to present our graphs both visually and interactively.
