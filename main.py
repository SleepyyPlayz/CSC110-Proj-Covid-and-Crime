...
for pt in read.PROV_AND_TERR:
    police_data_2020_physical, police_data_2020_non_physical = analyze.get_police_data(police_data_raw, pt, 2020,
                                                                                       'physical')
    total_police_data_2020_physical = analyze.get_police_data_totals(police_data_2020_physical, 'Physical', 2020)
...
for pt in read.PROV_AND_TERR:
    ...
    total_police_data_2020_public = analyze.get_police_data_totals(police_data_2020_public, 'Public', 2020)
    total_police_data_2020_private = analyze.get_police_data_totals(police_data_2020_private, 'Private', 2020)
...
for pt in read.PROV_AND_TERR:
    police_data_2021_physical, police_data_2021_non_physical = analyze.get_police_data(police_data_raw, pt, 2021,
                                                                                       'physical')
    total_police_data_2021_physical = analyze.get_police_data_totals(police_data_2021_physical, 'Physical', 2021)
...
for pt in read.PROV_AND_TERR:
    ...
    total_police_data_2021_public = analyze.get_police_data_totals(police_data_2021_public, 'Public', 2021)
    total_police_data_2021_private = analyze.get_police_data_totals(police_data_2021_private, 'Private', 2021)
